...
public enum HttpResponseStatus implements ResponseStatus {
    ...
    /**
     * Feign Client Fallback 统一的返回错误码
     */
     ...
     * {@code reasonPhrase}.
     */
    HttpResponseStatus(final Integer code, final String message) {
        if (code < -1) {
            throw new IllegalArgumentException(
                    "code: " + code + " (expected: 0+ and !=-1) ");
        }
