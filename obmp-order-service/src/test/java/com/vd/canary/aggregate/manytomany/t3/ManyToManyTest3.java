...
import com.vd.canary.obmp.order.api.response.PomPurchaseContractBriefDetailResp;
...
public class ManyToManyTest3 {
    private static ResponseBO<List<PomPurchaseContractBriefDetailResp>> responseBO;
    ...
    public static void setup() {
        PomPurchaseContractBriefDetailResp p1 = JSON.parseObject(text1, PomPurchaseContractBriefDetailResp.class);
        PomPurchaseContractBriefDetailResp p2 = JSON.parseObject(text2, PomPurchaseContractBriefDetailResp.class);

        List<PomPurchaseContractBriefDetailResp> briefDetailResp = new ArrayList<>();
